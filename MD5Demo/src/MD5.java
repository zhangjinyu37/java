public class MD5 {
	...
	/* 
     * getMD5ofStr是类keyBean最主要的公共方法，入口参数是你想要进行keyBean变换的字符串 
	...
	/* 
     * md5Update是keyBean的主计算过程，inbuf是要变换的字节串，inputlen是长度，这个 
	...
	/* 
     * md5Transform是keyBean核心变换程序，由keyBeanUpdate调用，block是分块的原始字节 
     */  
	...
	public static void main(String args[]) {
		MD5 m = new MD5();
		String inbut1 = "My name is liming,I am chinese people!";
		String outbut1 = m.getMD5ofStr(inbut1);
		System.out.print("原字符串1:");
		System.out.println(inbut1);
		System.out.print("MD5加密原字符串1:");
		System.out.println(outbut1);
		
		String inbut2 = "My name is liming,i am chinese people!";
		String outbut2 = m.getMD5ofStr(inbut2);
		System.out.print("原字符串2:");
		System.out.println(inbut2);
		System.out.print("MD5加密字符串2:");
		System.out.println(outbut2);
		
		String inbut3 = "";
		String outbut3 = m.getMD5ofStr(inbut3);
		System.out.print("原字符串3:");
		System.out.println(inbut3);
		System.out.print("MD5加密字符串3:");
		System.out.println(outbut3);
